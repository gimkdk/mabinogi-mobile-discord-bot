...
class GlassRaidView(View):
    ...
    async def update_embed(self):
        ...
        try:
            ...
            embed.set_thumbnail(url="https://dszw1qtcnsa5e.cloudfront.net/community/20250326/d8fe4dce-de91-4cde-9bc0-43ce3ae99ed6/%EA%B8%80%EB%9D%BC%EC%8A%A4%EA%B8%B0%EB%B8%8C%EB%84%A8%EA%B3%BC%EC%9D%98%EC%A1%B0%EC%9A%B0.png")
    ...
    @discord.ui.button(label="지원하기", style=discord.ButtonStyle.green, custom_id="apply_glass_button")
    async def apply_glass_button(self, button: Button, interaction: Interaction):
    ...
    @discord.ui.button(label="지원취소", style=discord.ButtonStyle.red, custom_id="cancel_glass_button")
    async def cancel_glass_button(self, button: Button, interaction: Interaction):
        user_id = str(interaction.user.id)
        try:
            # 지원 내역 삭제
